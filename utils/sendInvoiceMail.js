...
// totalAmount, orderId, items , address
const sendInvoiceEmail = async ({ name, email, verificationToken, origin }) => {
...
const invoiceTemplate = async function () {
  return `<!DOCTYPE html>
<html>
<head>
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
          <tr>
            <td align="center" valign="top" style="padding: 36px 24px;">
              <a href="https://https://ecommerce-jitendra.netlify.app/.com" target="_blank" style="display: inline-block;">
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
          ...
          <tr>
            <td align="left" bgcolor="#ffffff" style="padding: 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">
              <p style="margin: 0;">Here is a summary of your recent order. If you have any questions or concerns about your order, please <a href="https://https://ecommerce-jitendra.netlify.app/.com">contact us</a>.</p>
            </td>
          </tr>
          <!-- end copy -->
          ...
          <tr>
            <td align="left" bgcolor="#ffffff" style="padding: 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">
              ...
              <td align="left" bgcolor="#D2C7BA" width="20%" style="padding: 12px;font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;"><strong>Price</strong></td>
                ...
                ${items.map(
                  (item) => `<tr>
                  <td align="left" width="60%" style="padding: 6px 12px;font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">${item.name}</td>
                  ...
                  <td align="left" width="20%" style="padding: 6px 12px;font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">₹ ${item.price}</td>
                </tr>`
                )}
                ...
                <table align="left" border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 300px;">
                  <tr>
                    <td align="left" valign="top" style="padding-bottom: 36px; padding-left: 36px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">
                      ...
                      <p>${address.street} <br> ${address.city} <br> ${address.state} <br> ${address.pinCode} </p>
                    </td>
                  </tr>
                </table>
              </div>
    ...
    <tr>
      <td align="center" bgcolor="#D2C7BA" style="padding: 24px;">
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
          ...
          <tr>
            <td align="center" bgcolor="#D2C7BA" style="padding: 12px 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 20px; color: #666;">
              <p style="margin: 0;">To stop receiving these emails, you can <a href="https://https://ecommerce-jitendra.netlify.app/.com" target="_blank">unsubscribe</a> at any time.</p>
...
//       paymentId: 'pay_NUtJqcNngKLtlg',
//       status: 'pending',
//       address: {
//         name: 'Jitendra',
//         email: 'jitendra.singh.sola@gmail.com',
//         phone: 8094581461,
//         street: '#73 , 1st Main Rd, Prashant Layout',
//         city: 'bengaluru',
//         state: 'Karnataka',
//         pinCode: 560066,
//         _id: new ObjectId("658ea39f82a3030c46ceeb3a")
//       },
//       quantity: 1,
//       totalAmount: 1346,
//       _id: new ObjectId("65b924c5c723509013a6769b"),
//       __v: 0
//     },
//     {
//       name: 'Sneakers Joggers Shoes',
//       price: 40,
//       description: 'Gender: Men , Colors: Same as DisplayedCondition: 100% company New',
//       category: 'mens-shoes',
//       company: 'Sneakers',
...
//       quantity: 1,
//       totalAmount: 35,
//       _id: new ObjectId("65b924c9c723509013a67706"),
//       __v: 0
//     }
//   ]
